...
ADDON ?= "@eeacms/volto-block-image-cards"
...
.PHONY: backend
backend: api/bin/instance		## Build Plone 5.2
...
.PHONY: help
help:		## Show this help.
	@echo Run "make <target>", where target is one of below
